...
function App() {
    ...
    const darkTheme = createTheme({
        palette: {
            ...
            // text: {
            //     primary: '#ECECEC', // Change the primary text color
            // },
        },
        typography: {
        ...
        <ThemeProvider theme={darkTheme}>
            ...
            >
                <Grid
                    ...
                    spacing={3}
                    alignItems={'stretch'}
                    sx={{ padding: 5, justifyContent: 'left' }}
                >
            ...
            >
                ...
                >
                    ...
                    <Grid size={{ xs: 12, md: 6 }} flexGrow={2}>
                    ...
                    <Grouping groupHeading='Brisbane Council Emergency Dashboard' >
                        ...
                        />
                        <p style={{margin: 0}}>Note: This page was never designed for mobile, this card will only work on desktop</p>
